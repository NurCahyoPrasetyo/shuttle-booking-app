...
import type { SearchFormData, ShuttleSchedule } from "@/lib/types";
    ...
    <div className="max-w-4xl mx-auto">
        ...
        <Card className="bg-card">
          <CardContent className="pt-6">
            ...
            <div className="mt-2 text-sm text-muted-foreground">
              Penumpang:{" "}
              <span className="font-medium">{searchData.passengerName}</span>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="mb-4">
        <h2 className="text-xl font-bold text-foreground">
          Shuttle Tersedia ({schedules.length} operator)
        </h2>
        <p className="text-muted-foreground">
          Pilih jadwal keberangkatan yang sesuai
        </p>
      </div>
      ...
      <Card className="mt-8 bg-muted/50">
        <CardContent className="pt-6">
          <div className="text-sm text-muted-foreground">
            ...
            <ul className="space-y-1 text-left max-w-2xl list-disc mx-8">
              <li>
                Harap tiba di lokasi keberangkatan 15 menit sebelum jadwal
              </li>
              <li>
                Tiket yang sudah dibeli tidak dapat dibatalkan atau diubah
              </li>
